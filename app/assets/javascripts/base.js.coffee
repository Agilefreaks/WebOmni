jQuery ($) ->
  $webOmniApp =
    ...
    showcaseManager: window.ShowcaseManager
    devicesManager: window.DevicesManager
    ...
    callbacks:
      ...
      showUsecasesForSelectedDevices: ->
        selectedDevices = $webOmniApp.devicesManager.getSelectedDevices()
    ...
    appPlugins:
      initFullPage: ->
        ...
        $container.fullpage
          ...
          afterRender: () ->
            $webOmniApp.devicesManager.showDevices()
