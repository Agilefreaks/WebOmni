window.DevicesPresenter =
  $devicesWrapper: $("#devices-wrapper")

  devices: [
    { id: 'laptop', name: 'Laptop', className: 'device-laptop', handlers: ['navigation', 'incoming-call'], events: ['navigation'] }
    { id: 'tablet', name: 'Tablet', className: 'device-tablet', handlers: ['navigation', 'incoming-call'], events: ['navigation'], isChecked: false }
    { id: 'phone', name: 'Phone', className: 'device-phone', handlers: ['navigation'], events: ['navigation', 'incoming-call'], isChecked: false }
    { id: 'tv', name: 'TV', className: 'device-tv', handlers: [], events: [], isChecked: false }
  ]
